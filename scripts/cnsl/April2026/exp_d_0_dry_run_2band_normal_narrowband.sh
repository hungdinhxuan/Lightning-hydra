#!/bin/bash
# EXP D dry run: MDT×MBCT LoRA — two bands (normal + narrowband).
...
#   bash scripts/cnsl/April2026/exp_d_0_dry_run_2band_normal_narrowband.sh
#   bash scripts/cnsl/April2026/exp_d_0_dry_run_2band_normal_narrowband.sh -d 0
...
echo "[exp_d_0_dry_run_2band_normal_narrowband] OK — check logs for val/view_* and train/loss."
