...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=16 python src/train.py \
  experiment=cnsl/April2026/21st_xlsr_conformertcm_mdt_lora \
  ++data.data_dir="/dev/shm/dsd_corpus_pool_21April2026" \
  ++data.args.protocol_path="/dev/shm/dsd_corpus_pool_21April2026/protocol.txt" \
