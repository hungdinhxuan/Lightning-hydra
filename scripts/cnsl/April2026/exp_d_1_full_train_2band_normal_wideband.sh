#!/bin/bash
#
# EXP D foreground full training: MDT×MBCT LoRA — normal + wideband (8 views).
...
#   bash scripts/cnsl/April2026/exp_d_1_full_train_2band_normal_wideband.sh
#   bash scripts/cnsl/April2026/exp_d_1_full_train_2band_normal_wideband.sh -d 0
