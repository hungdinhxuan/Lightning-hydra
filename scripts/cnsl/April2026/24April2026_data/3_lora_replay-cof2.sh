...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=16 python src/train.py \
  experiment=cnsl/April2026/26th_xlsr_conformertcm_mdt_cl_conf-2 \
  trainer=default \
  ++data.data_dir="/data/Datasets/dsd_corpus_pool_24April2026" \
  data.novel_protocol_path="/data/Datasets/dsd_corpus_pool_24April2026/novel_24_april.txt" \
  data.replay_protocol_path="/data/Datasets/dsd_corpus_pool_24April2026/replay_feb_dataset.txt" \
