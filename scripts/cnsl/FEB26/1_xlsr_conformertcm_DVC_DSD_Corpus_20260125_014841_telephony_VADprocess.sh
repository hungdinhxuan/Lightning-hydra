...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=5 uv run src/train.py \
    ...
    ++data.data_dir="data/DVC_DSD_Corpus_20260125_014841_telephony_VADprocess" \
    ++data.args.protocol_path="data/DVC_DSD_Corpus_20260125_014841_telephony_VADprocess/protocol.txt" logger=wandb \
