...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=8 python src/train.py \
  experiment=cnsl/May2026/13th_xlsr_conformertcm_mdt_cl-balance-class-conf-1 \
  trainer=default \
  ++data.data_dir="/data/Datasets/dsd_corpus_pool_13May2026" \
  data.novel_protocol_path="/data/Datasets/dsd_corpus_pool_13May2026/novel_13_May_full.txt" \
