...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=5 uv run src/train.py \
    experiment=cnsl/March2026/xlsr_conformertcm_mdt2 \
    ++data.data_dir="data/DSD-Large-Corpus_04_March_SpeechOnly/final_output" \
    ++data.args.protocol_path="data/DSD-Large-Corpus_04_March_SpeechOnly/final_output/protocol.txt" logger=wandb \
