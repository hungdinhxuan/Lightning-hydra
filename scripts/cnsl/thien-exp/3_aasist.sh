...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=16 python src/train.py \
  experiment=thien_exp/aasist \
  ++data.data_dir="data/thien_benchmark/April16_2026_Thien_recording" \
  ++data.args.protocol_path="data/thien_benchmark/April16_2026_Thien_recording/protocol_train_dev_eval.txt" \
