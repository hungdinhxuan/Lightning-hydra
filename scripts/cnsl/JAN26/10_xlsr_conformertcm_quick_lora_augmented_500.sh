...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=5 python src/train.py \
    ...
    ++data.data_dir="data/DVC_DSD-Large-Corpus/pool/dsd_corpus_may_training_la_codec_aug_500" \
    ++data.args.protocol_path="data/DVC_DSD-Large-Corpus/pool/dsd_corpus_may_training_la_codec_aug_500/protocol.txt" logger=wandb \
