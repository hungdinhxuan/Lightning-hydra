...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE OMP_NUM_THREADS=5 python src/train.py \
    experiment=wildspoof/Nov3/xlsr_conformertcm_mdt_lora \
    ++data.data_dir="data/WildSpoof/spoofceleb_codec_v2" \
    ++data.args.protocol_path="data/WildSpoof/spoofceleb_codec_v2/protocol_spoofceleb_codec.txt" logger=wandb \
