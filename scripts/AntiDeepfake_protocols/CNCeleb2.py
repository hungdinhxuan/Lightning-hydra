...
dataset_name = 'CNCeleb2'
data_folder = os.path.join(root_folder, dataset_name, 'CN-Celeb2_flac', 'data')
ID_PREFIX = 'CNCeleb2-'
...
# ['$ROOT', 'CNCeleb2', 'CN-Celeb2_flac', 'data', 'id10936', 'recitation-02-028.flac']
        speaker = parts[4]
        attack = '-'
        label = 'real'
        proportion = '-'
