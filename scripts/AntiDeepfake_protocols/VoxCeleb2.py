...
# ['$ROOT', 'VoxCeleb2', 'dev', 'aac', 'id00082', 'lXxPuqI6Yac', '00146.wav']
        trail = parts[5]
        speaker = parts[4]
        attack = '-'
        label = 'real'
        proportion = '-'
        language = '-'
        file_id = f"{speaker}-{trail}-{os.path.splitext(parts[-1])[0]}"
        try:
