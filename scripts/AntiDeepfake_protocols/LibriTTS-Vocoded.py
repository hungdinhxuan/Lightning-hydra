#!/usr/bin/env python
"""script to create protocol for LibriTTS database
...
dataset_name = 'LibriTTS-Vocoded'
data_folder = os.path.join(root_folder, dataset_name)
ID_PREFIX = 'LibriTTS-Vo-'
...
# ['$ROOT', 'LibriTTS-Vocoded', 'hn_sinc_nsf_hifi', 'train-clean-360', '2638', '10172', '2638_10172_000059_000002.wav']
        attack = parts[2]
        subset = parts[3]
        if 'train' in subset:
            proportion = 'train'
