...
import torch
from src.models.components.xlsr_adapter_conformertcm import Model as XLSRConformerTCM
...
class XLSRConformerTCMLitModule(LightningModule):
    ...
    def __init__(
        ...
        self.net = XLSRConformerTCM(args['conformer'], ssl_pretrained_path, n_layers)
