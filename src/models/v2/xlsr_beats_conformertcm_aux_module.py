import torch
from src.models.components.xlsr_beats_conformertcm_aux import Model as XLSRBeatsConformerTCMAux
from src.models.base.aux_normal_module import AuxNormalLitModule
from typing import Any, Dict, Tuple, Union
from torch import nn

class XLSRBeatsConformertcmAuxLitModule(AuxNormalLitModule):
    def __init__(
        self,
    ...
    def init_model(self, **kwargs) -> nn.Module:
        ...
        return XLSRBeatsConformerTCMAux(
