import torch
from src.models.components.distil.distil_wav2vec2_hf_n_trans_layers_conformertcm import Model as Distil_Wav2vec2_HF_N_Trans_Layer_ConformerTCM
from src.models.base.normal_module import NormalLitModule
from typing import Any, Dict, Tuple, Union
from torch import nn

class Distil_Wav2vec2_HF_N_Trans_Layer_ConformerTCMNormalLitModule(NormalLitModule):
    def __init__(
        self,
    ...
    def init_model(self, **kwargs) -> nn.Module:
        ...
        print(_args)
        print(_kwargs)
        return Distil_Wav2vec2_HF_N_Trans_Layer_ConformerTCM(_args, **_kwargs)
