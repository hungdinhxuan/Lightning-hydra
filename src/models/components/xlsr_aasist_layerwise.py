...
'''
    This code references from the following paper:
    Comprehensive Layer-wise Analysis of SSL Models for Audio Deepfake Detection
    Paper: https://arxiv.org/abs/2211.06073
    
    Code: https://github.com/Yaselley/SSL_Layerwise_Deepfake/blob/main/model.py#L525
'''
...
class SSLModel(nn.Module):
    ...
    def freeze_feature_extraction(self):
        ...
        print("Freezing feature extraction layers of the model.")
