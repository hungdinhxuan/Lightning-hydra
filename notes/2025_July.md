...
### top April
```bash
./scripts/benchmark.sh -g 3 -c cnsl/xlsr_vib_large_corpus -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/vib_conf-5_gelu_acmccs_apr3_moreko_telephone_epoch22.pth -r logs/results/noisy_benchmark -n "ToP_April" -l false -s false
```

## G1-V1 (self-code)
```bash
./scripts/benchmark.sh -g 2 -c cnsl/lora/elevenlabs/xlsr_conformertcm_mdt_more_elevenlabs -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/notebooks/S_241214_conf-1.pth -a /home/hungdx/logs/train/runs/2025-07-02_13-59-08/checkpoints/epoch_010.ckpt -r logs/results/noisy_benchmark -n "ConformerTCM_MDT_LoRA_exp_g1_v1_july2" -l false
```
