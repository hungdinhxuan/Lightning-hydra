...
### top April
```bash
./scripts/benchmark.sh -g 3 -c cnsl/xlsr_vib_large_corpus -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/vib_conf-5_gelu_acmccs_apr3_moreko_telephone_epoch22.pth -r logs/results/noisy_benchmark -n "ToP_April" 
```


### Baseline
```bash
./scripts/benchmark.sh -g 2 -c cnsl/lora/elevenlabs/xlsr_conformertcm_mdt_infer -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/notebooks/S_241214_conf-1.pth -r logs/results/noisy_benchmark -n "Conformer_MDT_DEC2024_correct" -l false
```

### Baseline-variable-length
```bash
./scripts/benchmark.sh -g 3 -c cnsl/lora/elevenlabs/xlsr_conformertcm_mdt_infer_var -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/notebooks/S_241214_conf-1.pth -r logs/results/noisy_benchmark -n "Conformer_MDT_DEC2024_correct_var"
```

## ConformerTCM + MDT paper 
```bash
./scripts/benchmark.sh -g 3 -c huggingface_benchmark/xlsr_conformertcm_mdt_lora_infer -b data/shortcutASV -m /nvme2/hungdx/tcm_add/models/Conformer_w_TCM_LA_WCE_1e-06_ES144_H4_NE4_KS31_AUG3_w_sin_pos_multiview/best/avg_5_best_4.pth -r logs/results/noisy_benchmark -l False -n "Conformer_MDT_LA19"
```
## AASIST-SSL + MDT paper
```bash
./scripts/benchmark.sh -g 2 -c huggingface_benchmark/xlsr_aasist_mdt_paper -b data/shortcutASV -m /nvme2/hungdx/Lightning-hydra/logs/train/runs/2024-10-16_21-04-31-conf-2/checkpoints/averaged_top5.ckpt -r logs/results/noisy_benchmark -l True -n "AASIST_SSL_MDT_LA19"
```
